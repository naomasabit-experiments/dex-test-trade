...
function execTrade(from_account, to_account, value, tokenGet, amountGet, tokenGive, amountGive, expires, nonce){
  var data = contract.trade.getData(tokenGet, amountGet, tokenGive, amountGive, expires, nonce);
  console.log(data);
  var rawTx = setTransaction(data, from_account, to_account, value);
  sendTransaction(rawTx);
}
